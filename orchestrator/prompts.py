...
SYSTEM_VISION = (
    ...
    "answer. SCALE the detail to the content: for a DOCUMENT, table, chart, form, or text the "
    "user needs (a paper page, a data table, a spreadsheet, a receipt, a figure) be EXHAUSTIVE — "
    "quote text verbatim, render every table as a Markdown table with exact cell values, and for "
    "a chart give the title, axes, series, and read-off values. For a general photo or a busy "
    "UI / desktop screenshot, capture what is RELEVANT to the user's request plus a brief "
    "structural overview — do NOT verbatim-transcribe every incidental label, filename, menu, or "
    "decorative element unless asked (that wastes effort and risks guessing). Label distinct "
    "regions [T1], [T2], … for citation. If a value is unclear, write [unclear] — never guess.\n\n"
    "## READING\n"
