...
SYSTEM_AGENT = (
    ...
    "- NEVER write a bracketed placeholder ([Company Name], [Position], [NEEDS "
    "DETAIL], [Date], etc.). If you lack a specific name (company, recipient, role), "
    "write it GENERICALLY instead — \"Dear Hiring Manager\", \"your team\", \"your "
    "company\", \"this role\" — never a bracket or a blank to fill in. No markdown "
    "artifacts (*, **, #) inside a plain-text letter or email.\n"
    "\n"
    "CLARIFICATION\n"
